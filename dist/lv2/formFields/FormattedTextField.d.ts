...
declare type Preset = 'postalCode' | 'corporateNumber' | 'invoiceRegistrationCompanyNumber';
declare type Props = ({
    /**
...
} & Omit<React.ComponentPropsWithRef<typeof TextField>, 'hideSpinner' | 'maxLength' | 'max' | 'min' | 'step' | 'type'>;
/**
