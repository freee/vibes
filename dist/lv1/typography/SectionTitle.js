...
import { HeadlineFont2, MobileBoundaryWidth, MobileHeadlineFont2, VibesBlackColor, } from '../../constants';
...
})(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  color: ", ";\n  font: ", ";\n\n  ", "\n"], ["\n  color: ", ";\n  font: ", ";\n\n  ", "\n"])), VibesBlackColor, HeadlineFont2, function (_a) {
    var responsive = _a.responsive;
    return responsive
        ? "\n        @media (max-width: ".concat(MobileBoundaryWidth, ") {\n          font: ").concat(MobileHeadlineFont2, ";\n        }")
        : '';
});
var RenderSectionTitle = function (_a, ref) {
    var _b = _a.headlineLevel, headlineLevel = _b === void 0 ? 2 : _b, props = __rest(_a, ["headlineLevel"]);
    return (React.createElement(Style, __assign({ responsive: useResponsive(), headlineLevel: headlineLevel, tabIndex: -1 }, props, { ref: ref })));
};
var SectionTitle = React.forwardRef(RenderSectionTitle);
