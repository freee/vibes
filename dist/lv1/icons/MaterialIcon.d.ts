...
declare type Props = {
     ...
     */
    color?: 'inherit' | 'white' | 'P1' | 'P2' | 'P3' | 'P4' | 'P5' | 'P6' | 'P7' | 'P8' | 'P9' | 'P10' | 'S1' | 'S2' | 'S3' | 'S4' | 'S5' | 'S6' | 'S7' | 'S8' | 'S9' | 'S10' | 'RE2' | 'RE4' | 'RE5' | 'RE7' | 'RE10' | 'OR2' | 'OR4' | 'OR5' | 'OR7' | 'OR10' | 'YE2' | 'YE4' | 'YE5' | 'YE7' | 'YE10' | 'YG2' | 'YG4' | 'YG5' | 'YG7' | 'YG10' | 'GR2' | 'GR4' | 'GR5' | 'GR7' | 'GR10' | 'BG2' | 'BG4' | 'BG5' | 'BG7' | 'BG10' | 'PU2' | 'PU4' | 'PU5' | 'PU7' | 'PU10' | 'GY1' | 'GY2' | 'GY4' | 'GY5' | 'GY7' | 'GY10';
 ...
 */
declare const MaterialIcon: React.FC<Props>;
